...
t1_ = time.time()
def steg(OutFile, SeedValue, BioTone, VoiceFile, Face1, Face2=None, Face3=None, Face4=None, Face5=None,  Palm=None,  Iris=None, Ear=None):
    ...
    Grids = {"BioTone":[VoiceFile, [1,1]], "Faces":[Face1, [0,0]], "Face2":[Face2, [0,1]], "Face3":[Face3, [0,2]], "Face4":[Face4, [1,0]], "Face5":[Face5, [1,2]], "Palm":[Palm, [2,0]], "Iris":[Iris, [2,1]], "Ear":[Ear, [2,2]]}
...
steg(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4], sys.argv[5])
t2_ = time.time()
