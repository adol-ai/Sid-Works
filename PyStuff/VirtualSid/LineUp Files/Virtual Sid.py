        ...
        try:
            if q_ is True:
                ...
                if "all" in q_ or "full" in q_:
                    e=""
                    u=""
                for __l__ in s.find_all('a')[50:e]:
                    print("◉",__l__.text)
                ...
                month()
            elif ("describe you" in q_ or "about you" in q_ or "personal sketch" in q_ or "about sid" in q_ or ("description" in q_ and "you" in q_)) and "youtube" not in q_:
                sid_info()
                ...
                try:
                    try:
                        ...
                        pass
                    if (".com" not in q_ and ("dot" not in q_ and "com" not in q_) and "amazon" not in q_ and "youtube" not in q_ and "yahoo" not in q_ and "bigbasket" not in q_ and "bing" not in q_ and "aliexpress" not in q_ and "ebay" not in q_ and  "flipkart" not in q_ and "snapdeal" not in q_ and "browser" not in q_ and "search engine" not in q_ and "web" not in q_) or " app" in q_ or "set" in q_ or "bookmyshow" not in q_:
                        l= w.split()
                        try:   
                            i=l.index("open")+1
                            j=l.index("app")+1
                        ...
                        if v == "YES":
                            s=gTTS(text="hmm And this is {}".format(w),lang='en-us')
                            s.save(r"D:\Python Files\Audiofiles\VoiceOver.mp3")
                            playsound(r"D:\Python Files\Audiofiles\VoiceOver.mp3")
                            os.remove("D:\Python Files\Audiofiles\VoiceOver.mp3")
                    else:
                        try:
                            ...
                            print("uyfuyu115########@@@@")
                            print("Just Sit Back And Hold Tight!")
                            if "book" in q_ and "show" in q_:
                                print("We Are Heading To Bookmyshow...")
                                webbrowser.open("https://www.bookmyshow.com")
                            else:
