            ...
            if q_ is True:
                ...
                try:
                    ...
                    if w == "":
                        w=' '.join([x for x in l if x in l[i:]])
                    print("Just Sit Back And Hold Tight!")
                    print("We Are Heading To Amazon...")
                    chrome_options = webdriver.ChromeOptions()
                    driver = webdriver.Chrome(executable_path='C:\Program Files (x86)\Google\Chrome\Application\chromedriver.exe',options = chrome_options)
                    driver.get("https://www.amazon.com/")
                    search_form = driver.find_element_by_id('twotabsearchtextbox')
                ...
                try:
                    ...
                    if v == "YES":
                        playsound(r"D:\Python Files\Audiofiles\offline.mp3")
            elif ("tell" in q_ or "show" in q_ or "get" in q_) and "about" in q_:
                print("2")
                try:
                    if "sid" in q_ or "glenda" in q_:
                        l= q_.split()
                    ...
                    i=l.index('&')
                    q=l[37:i]
                    if ("List_" in q or "_of_" in q) and ("who" in q_ and "list" not in q_):
                        l=e[x[1]]
                        i=l.index('&')
                        q=l[37:i]
                        if ("List_" in q or "_of_" in q) and ("who" in q_ and "list" not in q_):
                    ...
                    if v == "YES":
                        playsound(r"D:\Python Files\Audiofiles\offline.mp3")
            elif ("breif" in q_ and "about" in q_) or "show me" in q_:
                print("3")
                try:
                    if "sid" in q_ or "glenda" in q_:
                        l= q_.split()
                ...
                try:
                    try:
                        ...
                        i=l.index('&')
                        q=l[37:i]
                        if ("List_" in q or "_of_" in q) and ("who" in w and "list" not in w):
                            l=e[x[1]]
                            i=l.index('&')
                            q=l[37:i]
                            if ("List_" in q or "_of_" in q) and ("who" in w and "list" not in w):
                ...
                try:
                    ...
                    pass
            elif ("open" in q_ and ("search" in q_ or "look" in q_ or "find" in q_)) or (("search" in q_ or "look" in q_ or "find" in q_ or "some" in q_) and ("on" in q_ or "in" in q_ or "for" in q_ or "over" in q_ or "from" in q_)) or (("on" in q_ or "in" in q_ or "over") and "for" in q_):
                try:
                    l= q_.split()
                    try:
                        print("1")
                    ...
                    print("Just Sit Back And Hold Tight!")
                    print("Here We Are Moving to {}".format(w))
