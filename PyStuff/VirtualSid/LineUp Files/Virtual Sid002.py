    ...
    try:
        ...
        try:
            ...
            try:
                ...
                print("I'm Fed Up!")
                s=gTTS(text="hmm, I'm fed up!",lang='en-uk')
...
def news_h():
    try:
        ...
        n=s.find(id='yDmH0d')
        i=n.find(class_='lBwEZb BL5WZb xP6mwf')
        for link in i.find_all('a')[3:]:
            print("◉",link.text,"\n")
        print("That's It For NOW!")
        if v == "YES":
            s=gTTS(text="hmm Here we have the Top news headlines",lang='en-uk')
            s.save(r"D:\Python Files\Audiofiles\VoiceOver.mp3")
            playsound(r"D:\Python Files\Audiofiles\VoiceOver.mp3")
            os.remove("D:\Python Files\Audiofiles\VoiceOver.mp3")
    except requests.exceptions.ConnectionError:
...
def health_news():
    try:
        ...
        print("That's It For NOW!")
        if v == "YES":
            s=gTTS(text="hmm Here we have the Health News",lang='en-uk')
            s.save(r"D:\Python Files\Audiofiles\VoiceOver.mp3")
            playsound(r"D:\Python Files\Audiofiles\VoiceOver.mp3")
            os.remove("D:\Python Files\Audiofiles\VoiceOver.mp3")
    except requests.exceptions.ConnectionError:
        ...
        try:
            if q_ is True:
                ...
                try:
                    ...
                    if v == "YES":
                        playsound(r"D:\Python Files\Audiofiles\offline.mp3")
            elif (("search" or "look" in q_ or "find" in q_) and "video" in q_) or "youtube search" in q_ or "youtube video" in q_ or "in youtube" in q_:
                try:
                    l= q_.split()
                    try:
                        i=l.index("some")+1
                    ...
                    print("Just Sit Back And Hold Tight!")
                    print("We Are Heading To Youtube...")
                    webbrowser.open("https://youtube.com/search?q=%s" % w)
                    if v == "YES":
                        s=gTTS(text="hmm Here are the results for {} in Youtube".format(w),lang='en-uk')
                        s.save(r"D:\Python Files\Audiofiles\VoiceOver.mp3")
                        playsound(r"D:\Python Files\Audiofiles\VoiceOver.mp3")
                        os.remove("D:\Python Files\Audiofiles\VoiceOver.mp3")
                except requests.exceptions.ConnectionError:
                ...
                try:
                    ...
                    print("That's It For NOW!")
                    if v == "YES":
                        s=gTTS(text="hmm Here we have the Top {} Technology News".format(u),lang='en-uk')
                        s.save(r"D:\Python Files\Audiofiles\VoiceOver.mp3")
                        playsound(r"D:\Python Files\Audiofiles\VoiceOver.mp3")
                        os.remove("D:\Python Files\Audiofiles\VoiceOver.mp3")
                except:
                ...
                try:
                    ...
                    pass
            elif "who is" in q_ and ("this" in q_ or "sid" in q_ or "glenda" in q_):
                ...
                html_con()
            elif ("weather" in q_ or "climate" in q_ or "forecast" in q_) and ("in" in q_ or "on" in q_ or "from" in q_):
                ...
                print("Weather ⤵",w.text)
                print("\n                  ","\t That's the Current Weather \t")
            elif "weather" in q_ or "climate" in q_ or "forecast" in q_:
                weather()
            elif "time" in q_:
                time()
                ...
                month()
            elif "meaning" in q_ or "meant" in q_:
                try:
                    try:
                    ...
                    if v == "YES":
                        playsound(r"D:\Python Files\Audiofiles\offline.mp3")
            elif (("summarize" in q_ or "summary" in q_ or "short" in q_ or "small" in q_) and ("about" in q_ or "on" in q_)) or (("tell" in q_ or "show" in q_ or "about" in q_ or "on" in q_) and "short" in q_):
                print("1")
                try:
                    if "sid" in q_ or "glenda" in q_:
                        l= q_.split()
                    ...
                    if v == "YES":
                        playsound(r"D:\Python Files\Audiofiles\offline.mp3")
            elif ("tell" in q_ or "show" in q_ or "get" in q_ or "give" in q_ or "breif" in q_ or "big note" in q_ or "long note" in q_ or "large note" in q_ or "huge note" in q_) and ("about" in q_ or "on" in q_):
                print("2")
                try:
                    print('6565')
                    try:
                    ...
                    try:
                        ...
                        try:
                            i=l.index("about")+1
                            j=l.index("of")
                            w__=' '.join([x for x in l if x in l[i:j]])
                        except:
                            try:
                                i=l.index("about")+1
                                j=l.index("in")
                        ...
                        try:
                            ...
                            try:
                                if "in breif" not in q_ or " in big note" not in q_ or "in long note" not in q_ or "in large note" not in q_ or "in huge note" not in q_:
                                    i=l.index("in")+1
                                    u=' '.join([x for x in l if x in l[i:]])
                            except:
                                pass
                        ...
                        if q != "":
                            ...
                            type(r)
                            s = BeautifulSoup(r.text,"html.parser")
                            if "breif" in q_ or "big note" in q_ or "long note" in q_ or "large note" in q_ or "huge note" in q_:
                                p=s.select('p')
                                i='\n'.join([o.text for o in p])
                                print(i)
                            else:
                    ...
                    if v == "YES":
                        playsound(r"D:\Python Files\Audiofiles\offline.mp3")
            elif (("what" in q_ or "who" in q_) and ("is" in q_ or "are" in q_)) and ("of" in q_ or "in" in q_):
                print("4")
                try:
                    l= q_.split()
                    print(">>>",l)
                ...
                try:
                    try:
                        ...
                        if q != "":
                            ...
                            i='\n'.join([o.text for o in p])
                            if len(i) < 100:
                                g = requests.get("https://google.com/search?q={} in cambridge dictionary".format(q_))
                                _s_ = BeautifulSoup(g.content, 'html.parser')
                                y=[]
                                for a in _s_.find_all('a', href=True):
                                    y.append(a['href'])
                                ...
                                if k == "" or k == "oxford":
                                    ...
                                    try:
                                        ...
                                        try:
                                            ...
                                            print("As Per Cambridge Dictionary:",e[1])
                                    except:
                                        pass
                                    try:
                                        r_ = requests.get("https://www.oxfordlearnersdictionaries.com/definition/english/{}".format(k))
                ...
                try:
                    ...
                    try:
                        ...
                        if ("birth" in q_ or "born" in q_) and ("day" in q_ or "anniversary" in q_):
                            ...
                            w_='date'
                        elif (("died" in q_ or "death" in q_) and ("day" in q_ or "anniversary")) or "die" in q_ or "killed" in q_ or "murder" in q_ or "death" in q_ or "assassinat" in q_:
                            w_='died'
                        elif "construct" in q_ or "open" in q_ or "build" in q_ or "built" in q_:
                            w_='open'
                        elif "record" in q_ or "compose" in q_:
                            w_="record"
                ...
                try:
                    ...
                    try:
                        ...
                        i=l.index("open")+1
                        j=l.index("and")
                        w_=' '.join([x for x in l if x in l[i:j]])
                        i_=l.index("for")+1
                        ...
                        try:
                            ...
                            i_=l.index("in")+1
                            w_=' '.join([x for x in l if x in l[i:]])
                        except:
                            try:
                                print("3")
                                i_=l.index("look")+1
                                                                    ...
                                                                    try:
                                                                        ...
                                                                        try:
                                                                            ...
                                                                            try:
                                                                                ...
                                                                                i=l.index("me")+1
                                                                                j=l.index("in")
                                                                                q=' '.join([x for x in l if x in l[i:j]])
                                                                                i_=l.index("in")+1
                                                                                w_=' '.join([x for x in l if x in l[i_:]])
                                                                            except:
                                                                                print("16")
                                                                                i=l.index("search")+1
                                                                                j=l.index("for")
                                                                            ...
                                                                            try:
                                                                                ...
                                                                                try:
                                                                                    ...
                                                                                    try:
                                                                                        ...
                                                                                        q=' '.join([x for x in l if x in l[i:j]])
                                                                                        i_=l.index("on")+1
                                                                                        w=' '.join([x for x in l if x in l[i_:]])
                                                                                    except:
                                                                                        pass
                    ...
                    if v == "YES":
                        s=gTTS(text="hmm These are the results for {} in {}".format(q,w),lang='en-us')
                        s.save(r"D:\Python Files\Audiofiles\VoiceOver.mp3")
                        playsound(r"D:\Python Files\Audiofiles\VoiceOver.mp3")
                        os.remove("D:\Python Files\Audiofiles\VoiceOver.mp3")
                except requests.exceptions.ConnectionError:
...
#==============================Thrid Updated & Tested Prototype  |*| 08/07/2020---09:46 PM==============================#
