            ...
            if q_ is True:
                ...
                try:
                    ...
                    try:
                        ...
                        try:
                            if v == "YES":
                                s=gTTS(text="hmm These are results for {} in internet".format(w),lang='en-us')
                                s.save(r"D:\Python Files\Audiofiles\VoiceOver.mp3")
                                playsound(r"D:\Python Files\Audiofiles\VoiceOver.mp3")
                                os.remove("D:\Python Files\Audiofiles\VoiceOver.mp3")
                        except:
                ...
                try:
                    ...
                    if v == "YES":
                        playsound(r"D:\Python Files\Audiofiles\offline.mp3")
            elif "who is" in q_ or "how is" in q_ or "how was" in q_: 
                print("7")
                try:
                    try:
                        try:
                    ...
                    if v == "YES":
                        playsound(r"D:\Python Files\Audiofiles\offline.mp3")
            elif "when was" in q_ or "where was" in q_ or "where is" in q_:
                print("8")
                try:
                    l= q_.split()
                    print(">>>",l)
