...
entry.grid(row=0, column=1, columnspan=4, ipadx=30, ipady=10)
...
btn_backspace = Button(root, text="ERASE", bd=5, bg="#E5EB39", width=15, command=backspace)
btn_backspace.grid(row=3, column=4)
...
button_reset = Button(root, text="RESET", bd=5, bg="#F24B4B",width=15, command=reset)
button_reset.grid(row=7, column=4)
...
button_convert = Button(root, text="CONVERT", bd=5, bg="#0BD72D", width=15,  command=convert)
...
l_bin_ans = Label(root, text="                  NIL                   ", borderwidth=3, height=2, relief="raised")
l_bin_ans.grid(row=9, column=2)

l_dec = Label(root, text="Decimal: ")
l_dec.grid(row=10, sticky=W)
l_dec_ans = Label(root, text="                  NIL                   ", borderwidth=3, height=2, relief="sunken")
l_dec_ans.grid(row=10, column=2)

l_oct = Label(root, text="Octal: ")
l_oct.grid(row=11, sticky=W)
l_oct_ans = Label(root, text="                  NIL                   ", borderwidth=3, height=2, relief="raised")
l_oct_ans.grid(row=11, column=2)

l_hex = Label(root, text="Hexa Decimal: ")
l_hex.grid(row=12, sticky=W)
l_hex_ans = Label(root, text="                  NIL                   ", borderwidth=3, height=2, relief="sunken")
