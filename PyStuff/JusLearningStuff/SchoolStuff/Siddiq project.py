...
btn_backspace = Button(root, text="ERASE", bd=5, bg="red", width=15, command=backspace)
...
button_reset = Button(root, text="RESET", bd=5, bg="orange",width=15, command=reset)
...
button_convert = Button(root, text="CONVERT", bd=5, bg="blue", width=15,  command=convert)
